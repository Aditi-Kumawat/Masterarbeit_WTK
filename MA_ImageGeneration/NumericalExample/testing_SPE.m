...
elseif strcmp(output_type,"fix")
    ...
    Y = SDOF_simulation(X_valid,Learning_type,'fix',fix_p,data_t);
 ...
 %MODIFY        
       ...
       elseif strcmp(output_type,"fix")
           ...
           for i = 1:num_repeat
               ...
               [T_p,Spa_p,Spv_p,Sd_p] = fns_response_spectra(Time(3)-Time(2),0.8*Acc,5,9.81,10);
               length(T_p)
           ...
           [T_o,Spa_o,Spv_o,Sd_o] = fns_response_spectra(fitting_GM.time(3)-fitting_GM.time(2),1.25*fitting_GM.ampl,5,9.81,10);
           ...
           %% Plot Spectra
            ...
            semilogx(T_o,Spv_o,'LineWidth',2., Color="#0072BD")
            hold on 
